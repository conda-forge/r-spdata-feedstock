About r-spdata-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-spdata-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1658&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-spdata-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-spdata` can be installed with `conda`:
...
```
mamba install r-spdata
```

It is possible to list all of the versions of `r-spdata` available on your platform with `conda`:
...
```
mamba search r-spdata --channel conda-forge
```
...
mamba repoquery search r-spdata --channel conda-forge

# List packages depending on `r-spdata`:
mamba repoquery whoneeds r-spdata --channel conda-forge

# List dependencies of `r-spdata`:
mamba repoquery depends r-spdata --channel conda-forge
```
